...
function createCard(item) {
    ...
    const buttonRemove = cardsItem.querySelector('.cards__trash');
    buttonRemove.addEventListener('click', () => {
        buttonRemove.closest('.cards__grid-item').remove()
    })

    const buttonZoom = cardsItem.querySelector('.cards__photo');
    const titleZoom = cardsItem.querySelector('.cards__title');
    buttonZoom.addEventListener('click', () => {
        popupZoomPhoto.querySelector('.popup__photo').src = buttonZoom.src;
